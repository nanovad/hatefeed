...
// This is a copy of the Dismissible widget found in the flutter/widgets library
// with keypress handling tacked on for our usecase.
// The widget is mostly unmodified, but it wraps the gesture detector in a
// KeyboardListener with a _handleKeyPress callback. This callback sets up and
// flings the animation controller as if a fling gesture was just completed.
...
/// Signature used by [KeyboardDismissible] to indicate that it has been dismissed in
/// the given `direction`.
///
/// Used by [KeyboardDismissible.onDismissed].
typedef DismissDirectionCallback = void Function(DismissDirection direction);

/// Signature used by [KeyboardDismissible] to give the application an opportunity to
/// confirm or veto a dismiss gesture.
///
/// Used by [KeyboardDismissible.confirmDismiss].
typedef ConfirmDismissCallback = Future<bool?> Function(DismissDirection direction);

/// Signature used by [KeyboardDismissible] to indicate that the dismissible has been dragged.
///
/// Used by [KeyboardDismissible.onUpdate].
typedef DismissUpdateCallback = void Function(DismissUpdateDetails details);

/// The direction in which a [KeyboardDismissible] can be dismissed.
// enum DismissDirection {
//   /// The [KeyboardDismissible] can be dismissed by dragging either up or down.
//   vertical,

//   /// The [KeyboardDismissible] can be dismissed by dragging either left or right.
//   horizontal,

//   /// The [KeyboardDismissible] can be dismissed by dragging in the reverse of the
//   /// reading direction (e.g., from right to left in left-to-right languages).
//   endToStart,

//   /// The [KeyboardDismissible] can be dismissed by dragging in the reading direction
//   /// (e.g., from left to right in left-to-right languages).
//   startToEnd,

//   /// The [KeyboardDismissible] can be dismissed by dragging up only.
//   up,

//   /// The [KeyboardDismissible] can be dismissed by dragging down only.
//   down,

//   /// The [KeyboardDismissible] cannot be dismissed by dragging.
//   none,
// }
...
///
/// {@tool dartpad}
/// This sample shows how you can use the [KeyboardDismissible] widget to
...
class KeyboardDismissible extends StatefulWidget {
  /// Creates a widget that can be dismissed.
  ///
  /// The [key] argument is required because [KeyboardDismissible]s are commonly used in
  ...
  @override
  State<KeyboardDismissible> createState() => _KeyboardDismissibleState();
}
...
/// See also:
///
///   * [KeyboardDismissible.onUpdate], which receives this information.
class DismissUpdateDetails {
  ...
  /// that the [KeyboardDismissible] is dragged across the threshold.
...
class _KeyboardDismissibleState extends State<KeyboardDismissible>
  ...
  void _handleKeyEvent(KeyEvent event) {
    ...
    if (event.logicalKey == LogicalKeyboardKey.arrowLeft) {
      ...
      _updateMoveAnimation();
      setState(() {
        _moveController.fling(velocity: _kMinFlingVelocity * 2 * _kFlingVelocityScale);
      });
